...
ifeq ($(config),debug)
TARGETDIR = build/Debug-windows-x86_64/bin
TARGET = $(TARGETDIR)/ImGui.lib
OBJDIR = build/Debug-windows-x86_64/obj/ImGui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -std=c++17

else ifeq ($(config),release)
TARGETDIR = build/Release-windows-x86_64/bin
TARGET = $(TARGETDIR)/ImGui.lib
OBJDIR = build/Release-windows-x86_64/obj/ImGui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -static
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -std=c++17 -static

else ifeq ($(config),dist)
TARGETDIR = build/Dist-windows-x86_64/bin
TARGET = $(TARGETDIR)/ImGui.lib
OBJDIR = build/Dist-windows-x86_64/obj/ImGui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -std=c++17
